...
declare global {
  namespace sigmate.Wiki {
    ...
    interface DocumentRawAttribs extends WikiAttribs {
      ...
      Collection?: CollectionAttribs['id'];
      // Nft?: NftAttribs['id'];
    ...
    interface BlockAttribs {
      ...
      document: {
        id: DocumentId;
        /**
         * Version of the document when this block was last modified
         */
        version: DocumentVersionId;
      };
    ...
    interface DocumentCRequest
      extends Pick<
        DocumentAttribs,
        'type' | 'title' | 'auditComment' | 'schema'
      > {
    ...
    interface DocumentURequest
      extends Partial<
        Omit<DocumentCRequest, 'keyInfo' | 'content' | 'collection' | 'nft'>
      > {
      id: DocumentAttribs['id'];
      keyInfo?: BlockURequest[];
      content?: BlockURequest[];
    }
